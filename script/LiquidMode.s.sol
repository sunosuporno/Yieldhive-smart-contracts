...
contract LiquidModeScript is Script {
    ...
    function run() public {
        ...
        liquidMode = new LiquidMode(
            ...
            address(0x2416092f143378750bb29b79eD961ab195CcEea5), // _EZETH
            address(0xe7903B1F75C534Dd8159b313d92cDCfbC62cB3Cd), // _WRSETH
            ...
            address(0x3621b06BfFE478eB481adf65bbF139A052Ed7321), // _ezEthEthProxy
            address(0xc30e51C9EDD92B9eeF45f281c712faaAf59912BA) // _wrsEthEthProxy
        );
